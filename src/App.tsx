...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-black overflow-hidden">
      ...
      <div className="relative min-h-screen w-full max-w-[390px] mx-auto bg-black/70 backdrop-blur-sm">
        {/* Main content container */}
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-12">
          {/* Avatar */}
          <div className={`transition-all duration-500 ${stage === 'revealed' ? 'mb-8' : 'mb-0'}`}>
            <Avatar
      ...
      {/* Desktop margins indicator */}
      <div className="hidden md:block fixed inset-0 pointer-events-none">
        <div className="absolute inset-y-0 left-0 w-[calc((100vw-390px)/2)] bg-gradient-to-r from-black to-transparent" />
        <div className="absolute inset-y-0 right-0 w-[calc((100vw-390px)/2)] bg-gradient-to-l from-black to-transparent" />
      </div>
    </div>
  );
}
